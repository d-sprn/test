...
class Player {
  ...
  playerAttackBlock() {
    const $attackPlayerRadio = Array.from(document.querySelectorAll('.menu__attack input')).indexOf(document.querySelector('.menu__attack input:checked'));
    const $blockPlayerRadio = Array.from(document.querySelectorAll('.menu__block input')).indexOf(document.querySelector('.menu__block input:checked'));
    return {
  ...
  playerHP () {
    if (player.playerAttackBlock().blockPlayer === rival.rivalAttackBlock().attackRival) {
      return player.hp;
    } else {
...
class Rival {
  ...
  rivalHP = () => {
    if (rival.rivalAttackBlock().blockRival === player.playerAttackBlock().attackPlayer) {
      return rival.hp;
    } else {
